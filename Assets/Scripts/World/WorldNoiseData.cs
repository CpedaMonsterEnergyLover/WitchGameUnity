...
public class WorldNoiseData
{
    ...
    {
        float[,] pmap = GenerateNoiseMap(seedHash, settings, psettings, Vector2.zero);
    ...
    private static float[,] GenerateNoiseMap(int seedHash, GeneratorSettings genSettings, NoiseSettings noiseSettings, Vector2 offset)
    {
